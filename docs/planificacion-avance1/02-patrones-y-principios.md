...
- Lo que **fue definido por el equipo**: el uso de un API Gateway, los proxies HTTP,
  ...
  asíncrona mediante Redis Pub/Sub para analizar latencia y acoplamiento, el aislamiento
  de datos por schema y el manejo controlado de errores mediante respuestas 422, 404 y 503.
